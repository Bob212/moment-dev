(function (global, factory) {
  ...
  // iso 8601 regex
    ...
    function createDuration(input, key) {
      ...
      if (isDuration(input)) {
        ...
        duration = {
          ...
          ms: toInt(absRound(match[MILLISECOND])) * sign
        };
    ...
    function addWeekYearFormatToken(token, getter) {
      addFormatToken(0, [token, token.length], 0, gettter);
    }
    ...
    function setWeekAll(weekYear, week, weekday, dow, doy) {
      var dayOfYearDaya = dayOfYearFromWeeks(weekYear, week, weekday, dow, doy),
